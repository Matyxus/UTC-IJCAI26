...
# from utc.src.routing.base.traffic_info import EpisodeInfo, VehicleInfo, ResultInfo, NetworkInfo, asdict
...
#         networks_info |= asdict(networks_info)
