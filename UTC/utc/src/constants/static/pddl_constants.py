...
class SOLVERS:
    ...
    "domain_file.pddl" "problem_file.pddl" "result_file.pddl", "timeout" [optional])
    """
    MERCURY: str = (DirPaths.PDDL_SOLVERS.format("Mercury/plan-utc") + " {0} {1} {2}")
    MERCURY2: str = "wsl /mnt/c/Users/Mates/Desktop/UTC/utc/data/solvers/Mercury/plan-utc {0} {1} {2}"
    MIP: str = ("python " + DirPaths.PDDL_SOLVERS.format("mip.py") + " {0} {1} {2} {3}")
    MIP_ALLOWED: str = ("python " + DirPaths.PDDL_SOLVERS.format("mip_allowed.py") + " {0} {1} {2} {3}")
