...
class MyFile:
    ...
    def __init__(self, file_path: str, mode: str = "w+", extension: str = ""):
        ...
        self.dir_path: str = ""  # Absolute path of parent directory
    ...
    @staticmethod
    def get_parent(file_path: Union[str, 'MyFile']) -> str:
        """
        :param file_path: path to file (either string or MyFile class)
        :return: Path to parent directory of given path
        """
        return str(Path(str(file_path)).parent)
