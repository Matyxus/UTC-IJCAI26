...
if __name__ == '__main__':
    ...
    scenario1: str = "itsc_25200_32400_comb_allowed_20" # DSO
    scenario2: str = "itsc_25200_32400" # DUO
    data = [
        DirPaths.SCENARIO_STATISTICS.format(scenario1) + f"/{scenario1}_edgeData.out.xml",
        # DirPaths.SCENARIO_STATISTICS.format(scenario2) + f"/{scenario2}_edgeData.out.xml",
    ...
    visualizer.plot_ci(visualizer.load_ci(data[2], graph), graph)
